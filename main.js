...
## 专业技能
- 掌握 HTML5 及 CSS3 ，熟悉传统布局、 Flex 布局、移动端适配等，有较好的审美及保证设计稿还原度。使⽤
- Scss / Less 开发 CSS
- 掌握 JavaScript ，掌握原型、原型链、闭包、⾯向对象等。了解 ES6 部分新特性
- React 及其相关库的开发经验，理解⽣命周期、组件通信、异步更新、 Hooks 、虚拟 DOM 、 Diff 算法等
- TypeScript 开发经验，理解接⼝、常⽤类型、可选链、空值合并运算符等
- Vue 结合相关库的开发经验，掌握组件及组件间数据传递的使⽤、响应式原理、路由等
- Git 的使⽤，代码仓库协同⼯作的能⼒、 npm 发布等经验
- React Native 移动端开发经验
- Webpack 打包项⽬的经验，了解常⽤的资源管理、插件、缓存等的使⽤

## 工作经历
### 深圳市法本信息技术股份有限公司-平安寿险⼈⼒外包
2020/5 - ⾄今
- 职位：前端开发（含移动端和 PC 端）
- 主要技术： React Native 、 Vue
- ⼯作内容：⼀、在捷报 PC 项⽬中担任 Vue Web 开发，期间还负责代码审核及脚⼿架的升级，曾在⼩组内分享代码的优化建议，提⾼代码的可维护性和可扩展性。⼆、在捷报 App 项⽬中担任 React Native 开发，其中负责⼀些公共组件的开发，如兼容安卓及 IOS 系统的阴影组件，提供友好的 API 进⾏⾃适应或固定宽⾼及其他样式的定义。三、负责捷报 CMS 开发，曾为技术端的需求提供建议及分析。
...
### 炫主页
[预览](https://caijialinxx.github.io/resume/)
